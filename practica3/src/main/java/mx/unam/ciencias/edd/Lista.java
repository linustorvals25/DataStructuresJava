...
public class Lista<T> implements Coleccion<T> {
    ...
    private class Iterador implements IteradorLista<T> {
        ...
        @Override
        public T previous() {
            // CORRECCIÓN: la condición debe ser !hasPrevious()
            if (!hasPrevious())
    ...
    public void inserta(int i, T elemento) {
        ...
        Nodo nuevo = new Nodo(elemento);
        Nodo temp = cabeza;
        // CORRECCIÓN: el bucle debe incrementar j, no i
        for (int j = 0; j < i - 1; j++) {
            temp = temp.siguiente;
        }
        nuevo.anterior = temp;
    ...
    public String toString() {
        ...
        while (temp != null) {
            ...
            if (temp.siguiente != null)
                sb.append(", ");
            // CORRECCIÓN: avanzar al siguiente nodo
            temp = temp.siguiente;
        }
        sb.append("]");
        return sb.toString();
    ...
    public boolean equals(Object objeto) {
        ...
        while (n1 != null) {
            if (!n1.elemento.equals(n2.elemento))
                return false;
            // CORRECCIÓN: avanzar ambos nodos
            n1 = n1.siguiente;
            n2 = n2.siguiente;
        }
        return true;
